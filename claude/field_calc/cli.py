...
Usage:
    ...
    Or use single-command mode:
        ...
        $ field-calc --field 1 0 0
        $ field-calc --potential 1 0 0
"""
...
║                            q: charge in Coulombs (e.g., 1e-9 for 1 nC)       ║
║    Example: add 0 0 0 1e-9                                                   ║
║    Example: add 1.5 2.0 0 -2e-9                                              ║
║                                                                              ║
║  REMOVING CHARGES:                                                           ║
...
"""
    ...
    def cmd_remove(self, args: list) -> None:
        ...
        """
        if len(args) != 1:
            print("Error: 'remove' requires 1 argument: charge_id")
...
Examples:
  ...
  Calculate potential:
    field-calc --charges "0,0,0,1e-9" --potential 1,0,0
"""
    )
