...
id1 = system.add_charge(0, 0, 0, 1e-9)    # old nC at origin
id2 = system.add_charge(1, 0, 0, -1e-9)   # -old nC at (old,0,0)
id3 = system.add_charge(0, 1, 0, 2e-9)    # 2 nC at (0,old,0)
...
system = ChargeSystem()
system.add_charge(-0.5, 0, 0, 1e-9)   # +old nC
system.add_charge(0.5, 0, 0, -1e-9)   # -old nC
